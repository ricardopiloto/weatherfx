import { blizzardSound, rainSound, thunderstormSound, heavyRainSound, currentWeather, topDownRain } from "./settings.js"; //imports settings variables, necessary because they go inside eval(effectName + 'Sound')
...
export function createEffect(effectName) {
    ...
    switch (effectName) {
        ...
        case 'drizzle': return effectCondition = new Effect(effectName, '', false, '', '', [getLightRain()], [])
        case 'snowGrains': return effectCondition = new Effect(effectName, '', false, '', '', [lightSnow, snowClouds], [coldClimate])

        case 'lightRain': return effectCondition = new Effect(effectName, '', false, '', '', [getLightRain(), lightFog], [])
        case 'moderateRain': return effectCondition = new Effect(effectName, 'moderateRain', true, 'rainSound', 'rain', [getModerateRain(), lightFog], [])
        case 'heavyRain': return effectCondition = new Effect(effectName, 'heavyRain', true, eval(effectName + 'Sound'), 'heavyRain', [getHeavyRain(), moderateFog], [darkClimate])

        case 'lightFreezingRain': return effectCondition = new Effect(effectName, '', false, '', '', [getLightRain(), lightFog], [coldClimate])
        case 'moderateFreezingRain': return effectCondition = new Effect(effectName, 'Moderate Freezing Rain', true, 'rainSound', 'rain', [getModerateRain(), lightFog], [coldClimate])
        case 'heavyFreezingRain': return effectCondition = new Effect(effectName, 'heavyFreezingRain', true, 'heavyRainSound', 'heavyRain', [getHeavyRain(), moderateFog], [coldClimate])
        ...
        case 'thunderstorm': return effectCondition = new Effect(effectName, 'thunderstorm', true, eval(effectName + 'Sound'), 'thunderstorm', [getHeavyRain(), heavyClouds, moderateFog], [darkClimate, lightning])

        case 'hail': return effectCondition = new Effect(effectName, 'hail', false, eval(effectName + 'Sound'), '', [hail, getHeavyRain(), heavyClouds, moderateFog], [darkClimate])

        case 'iceStorm': return effectCondition = new Effect(effectName, 'iceStorm', false, '', '', [getHeavyRain(), heavyClouds, moderateFog], [coldClimate])
        ...
        case 'overcastFreezing': return effectCondition = new Effect(effectName, 'overcast', false, '', '', [getLightRain(), grayClouds], [coldClimate])
        case 'overcastDrizzle': return effectCondition = new Effect(effectName, 'overcast', false, '', '', [getLightRain(), grayClouds], [])
